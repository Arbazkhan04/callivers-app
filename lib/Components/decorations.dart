import 'package:calliverse/Components/context_extensions.dart';
...
InputDecoration defaultInputDecoration(BuildContext context, {String? hint, String? label, TextStyle? textStyle, bool? isFocusTExtField = false, Widget? mPrefix}) {
  return InputDecoration(
    ...
    focusedErrorBorder: OutlineInputBorder(borderRadius: radius(), borderSide: BorderSide(color: isFocusTExtField == true ? context.dividerColor.withOpacity(0.7) : mainColor)),
    ...
    focusedBorder: OutlineInputBorder(borderRadius: radius(), borderSide: BorderSide(color: isFocusTExtField == true ? context.dividerColor.withOpacity(0.7) : mainColor)),
